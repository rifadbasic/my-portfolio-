      ...
      <div className="overflow-hidden border-t-[2px] border-zinc-300 dark:border-indigo-900 px-4 lg:px-8 py-4 lg:py-8 relative">
        ...
        <div className="relative flex">
          ...
          <code className="font-mono text-xs md:text-sm lg:text-base w-full">
            ...
            <div className="pl-6">
              <span className="text-zinc-800 dark:text-white">Experience:</span>
              <span className="text-zinc-600 dark:text-gray-400">&#39;</span>
              <span className="text-green-600 dark:text-green-400">
                {coderData.experience}
              </span>
              <span className="text-zinc-600 dark:text-gray-400">&#39;,</span>
            
            </div>
            <div className="pl-6">
              <span className="text-zinc-800 dark:text-white">Github:</span>
              <span className="text-zinc-600 dark:text-gray-400">&#39;</span>
              <span className="text-green-600 dark:text-green-400">
                {coderData.github}
              </span>
            ...
            <div className="pl-6">
              <span className="text-zinc-800 dark:text-white">Linkedin:</span>
              <span className="text-zinc-600 dark:text-gray-400">&#39;</span>
              <span className="text-green-600 dark:text-green-400">
                {coderData.linkedin}
              </span>
